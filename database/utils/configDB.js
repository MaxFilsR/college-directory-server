...
const dbUser = 'postgresql';
const dbPwd = 'postgresql';  // Note: If needed, change this password to match the password created for PostgreSQL database on the local machine.
